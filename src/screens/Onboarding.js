        ...
        <View style={{flex:1,backgroundColor:Colors.white}} >
            ...
            <View style={{flex:2,backgroundColor:'#fff'}} >
                ...
                <View style={{flex:1,flexDirection:'column',justifyContent:'flex-start',alignItems:'center',backgroundColor:'#fff'}} >
                    <Text style={{fontFamily:'OpenSans-Bold',color:Colors.black,fontSize:30}} >AKA Digital VN</Text>
                    <Text style={{maxWidth:'50%', fontFamily:'OpenSans-Medium',color:"#999",fontSize:14, textAlign:'center',paddingTop:10}} >Digital Transformation and Customer Experience Consulting
                                                                                                                                             Martech Platforms: DMP, automation, social</Text>
                </View>
